...
Se creó una aplicación shiny con el propósito de que una persona pueda hacer uso del modelo predictivo ingresando una respectiva fecha, en el siguiente enlace - - - - - se encuentra disponible un video explicativo sobre cómo usar dicha información aplicación. La aplicación se puede encontrar [Haciendo click aquí](https://kaamayam.shinyapps.io/Runt_app/)
